# Dispatch Server - YDKJ Sports the netshow
NOTE: Since the downloaded SRF files for Sports Netshow haven't been found, this will make reference to the downloaded SRF files for netshow 1.0 instead.
## `/cgi/register0.cgi`
The first file that the Sports Netshow engine tries to access if running the game for the first time.
...
## `/cgi/dispatch1.cgi`
The first file that the Sports Netshow engine tries to access.
