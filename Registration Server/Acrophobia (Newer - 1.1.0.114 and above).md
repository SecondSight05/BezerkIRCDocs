# Registration Server - Acrophobia (Newer Versions)
These only apply to versions 1.1.0.114 and above.
...
- `Show`: The "Show ID" of the game. (Always ACR for Acrophobia)
- `Origin`: The "Installer Origin ID".
  - Known Origin ID's: `1.1` for 1.1.0.114, `1.2` for 1.2.0.130, and `CPC` for 1.2.0.131
  - If the origin is `err`, then the client couldn't find it in the registry.
...
- `PlayerId`: The ID of the account.
...
- `0.999`: Validation was successful.
